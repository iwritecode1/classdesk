...
import { createBatch, formatCurrency } from '@/lib/api'
import type { BatchFeeConfig } from '@/lib/types'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        alert('Error creating batch: ' + response.error)
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen">
      <Header 
        ...
        description="Set up a new batch with fee configuration" 
      />
          ...
          <div className="md:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button type="submit" disabled={loading} className="flex-1 gradient-bg text-primary-foreground">
